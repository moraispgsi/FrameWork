            ...
            if (change.wasAdded() || change.wasReplaced()) {
                ...
                for (Node node : change.getAddedSubList()) {
                    ...
                    if (node instanceof Pluggable) {
                        ...
                        socketSet.getInvokelInputs().addAll(((Pluggable) node).getInvokelInputs());
                        socketSet.getInvokeOutputs().addAll(((Pluggable) node).getInvokeOutputs());
                    }
            ...
            if (change.wasRemoved() || change.wasReplaced()) {
                ...
                for (Node node : change.getRemoved()) {
                    ...
                    if (node instanceof Pluggable) {
                        ...
                        socketSet.getInvokelInputs().removeAll(((Pluggable) node).getInvokelInputs());
                        socketSet.getInvokeOutputs().removeAll(((Pluggable) node).getInvokeOutputs());
